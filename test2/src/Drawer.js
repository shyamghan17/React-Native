...
<Drawer.Screen name="screenB" component={screenB} options ={{ title:'B Screen', drawerIcon:({focused}) =>(
  <Icon name='btc' size ={focused ? 25 : 20 } color ={focused ? '#f08080' : '#ffff00'}/>
)}}/> 
<Drawer.Screen name="screenC" component={screenC} options ={{ title:'C Screen', drawerIcon:({focused}) =>(
